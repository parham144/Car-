...
export const OusEmadChat: React.FC<OusEmadChatProps> = ({
  ...
  useEffect(() => {
    setMessages([
      {
        sender: "mechanic",
        text: `با سلام و احترام، بنده «اوس عماد» هستم، در خدمت شما برای مشاوره فنی و تخصصی درباره خودروی ${carModel}. هر سوالی درباره کیفیت لوازم یدکی، استعلام قیمت قطعات در بازار لوازم یدکی و قطعات تهران، بررسی دستمزد مکانیک یا عیب‌یابی و بررسی علائم نقض فنی دارید بفرمایید تا شما را راهنمایی کنم.`,
  ...
  const handleSendMessage = async (textToSend: string) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          sender: "mechanic",
          text: data.reply || "خودرو یا قطعات مورد نظر شما را بررسی کردم؛ لطفاً سوال خود را کمی واضح‌تر مطرح بفرمایید تا به درستی شما را راهنمایی کنم.",
          timestamp: new Date().toLocaleTimeString("fa-IR"),
        },
      ]);
    } catch (err: any) {
